...
export const I18N = {
  "zh-CN": {
    ...
    settings: {
      ...
      welcomeCopy:
        "PawPal 会住在菜单栏或系统托盘和屏幕底部，定时提醒你休息、喝水和保持专注。分心检测目前仅支持 macOS，需要在系统设置里允许辅助功能权限。",
      dismissWelcome: "知道了",
      appearance: "外观",
      system: "系统",
      launchAtLogin: "开机自启",
      launchAtLoginHelp: "正式打包版本会在 macOS、Windows 或 Linux 登录后启动；Linux 使用 XDG autostart，开发环境只保存偏好。",
      about: "关于",
      version: "版本",
      releaseNotes: "更新说明",
  ...
  en: {
    ...
    settings: {
      ...
      welcomeCopy:
        "PawPal lives in the menu bar or system tray and near the bottom of your screen. It reminds you to take breaks, drink water, and stay focused. Distraction detection is macOS-only and requires accessibility permissions.",
      dismissWelcome: "Got it",
      appearance: "Appearance",
      system: "System",
      launchAtLogin: "Launch at Login",
      launchAtLoginHelp:
        "Packaged macOS, Windows, and Linux builds will start after login. Linux uses XDG autostart. Development builds only save the preference.",
      about: "About",
      version: "Version",
